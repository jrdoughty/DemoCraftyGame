...
Crafty.polygon.prototype = {
    ...
    containsPoint: function (x, y) {
        ...
        for (i = 0, j = p.length - 1; i < p.length; j = i = i +1) {
...
Crafty.matrix.prototype = {
    x: function (other) {
        ...
        for (var i = 0; i < this.height; i = i +1) {
            result[i] = [];
            for (var j = 0; j < other.width; j = j +1) {
                var sum = 0;
 ...
 */
    ...
    HashMap.prototype = {
        ...
        insert: function (obj) {
            ...
            for (i = keys.x1; i <= keys.x2; i = i +1) {
                //insert into all y buckets
                for (j = keys.y1; j <= keys.y2; j = j +1) {
                    hash = (i << 16) ^ j;
        ...
        if (typeof selector === "string") {
            ...
            for (e in entities) {
                ...
                if (and || or) { //multiple components
                    ...
                    for (; i < l; i = i +1) //loop over components
            ...
            if (comps && and)
                for (i = 0; i < l; i = i +1) this.extend(components[comps[i]]);
...
Crafty.extend({
    ...
    unbind: function (event, callback) {
        ...
        found_match = false;
        for (i = 0, l = global_callbacks.length; i < l; i = i +1) {
...
Crafty.DrawManager = (function () {
    ...
    var dirty_rects = [],
        ...
        rectManager = {
            ...
            clean: function () {
                var rect, obj, i;
                for (i = 0, l = changed_objs.length; i < l; i = i +1) {
                    obj = changed_objs[i];
                    rect = obj._mbr || obj;
...
Crafty.c("Particles", {
    ...
    _Particles: {
        ...
        render: function (context) {
            ...
            for (var i = 0, j = this.particleCount; i < j; i = i +1) {
...
Crafty.extend({
    ...
    viewport: {
        ...
        moveTo: function (x, y) {		//https://groups.google.com/forum/#!searchin/craftyjs/viewport/craftyjs/I9PdIPxCS1Y/m_Q7bx9gLPoJ
            var new_x = Math.floor(x),
                new_y = Math.floor(y),
                xdistance = new_x - this['_x'],
                ydistance = new_y - this['_y'],
            ...
            if (context && (xdistance !== 0 || ydistance !== 0)) {
